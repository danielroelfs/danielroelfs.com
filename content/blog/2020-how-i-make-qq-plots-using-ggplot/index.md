...
Since the majority of SNPs have a p-value that's between 1 and 0.01, plotting all these individual SNPs is unnecessary. Similar to what one would do in a Manhattan plot, we're going to filter out a large number of SNPs that have a p-value higher than 0.01. Recall that the -log~10~ of 0.01 is equal to 2, so we're going to take a subset of all expected values equal to or lower than 2. If this step causes some issue due to inflation etc., it will be easily visible in the plot later.
...
<img src="index_files/figure-html/print-plot-1.png" width="768" style="display: block; margin: auto;" />
