...
The voting booths (at least in the mainland part of the Netherlands) close at 21:00{{< sidenote for=\"sn-6\" >}}There are three municipalities in the Carribean that can vote until 02:00 CET{{< /sidenote >}}. This also marks the release of the first exit polls. I'm just copying the numbers from the TV broadcast as they come in and saving them in a `tibble()` using the `tribble()` function.
