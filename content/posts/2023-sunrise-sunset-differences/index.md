...
As you see, in neither cities 12:00 in the afternoon is perfectly in the middle between sunrise and sunset, although this trend is slightly enhanced for Oslo (again due to longitude differences){{< sidenote for="sn-2" >}}The difference between dusk and sunset is also a lot larger in Oslo, but we'll get back to that{{< /sidenote >}}. We can also see that the length of days in Oslo is longer in summer particularly because the mornings start earlier.
