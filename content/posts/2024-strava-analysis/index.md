...
Note that there are some overlapping points around the beginning and end of the year since I didn't account for the fact that the first of January isn't always on a Monday, and I also didn't bother debugging week numbering around New Year's day, so there's some errors at the beginning and the end of the year{{< sidenote for=\"sn-3\" >}}Like, the week of New Years Eve can be both week 52 and week 1{{< /sidenote >}}, and if I would make just this plot I would fix this, but for this purpose it works with this caveat I think.
