...
{{{< sidenote >}}}
_SCL_ stands for "scene classification" and is a synthetic layer used for various purposes besides masking clouds
{{{< /sidenote >}}} 
...
{{{< sidenote >}}}
Simplified, the process of applying two functions to each other to obtain a third is called [_convolution_](https://en.wikipedia.org/wiki/Convolution)
{{{< /sidenote >}}}
